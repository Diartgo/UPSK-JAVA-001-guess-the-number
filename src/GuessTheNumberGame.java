...
public class GuessTheNumberGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hola ** " + humanPlayer.getName() + " ** Elige un número entre 1 y 100.");
        ...
        while (!winner) {
            ...
            count++;
            System.out.println("****** Jugada nro: " + count + "******");
            ...
            if (isValidGuess(humanGuess)) {
                ...
                if (humanGuess < targetNumber) {
                    ...
                    System.out.println("El número que debes adivinar es mayor al elegido ");
                    ...
                    System.out.println("El número que debes adivinar es menor al elegido");
                } else {
                ...
                if (computerGuess < targetNumber) {
                    ...
                    System.out.println();
                    System.out.println(" ***Mejor suerte a la proxima ***" );
                    System.out.println();
                ...
                System.out.println("Solo debes escoger numeros del 1 al 100");
                break;
            }
        }
